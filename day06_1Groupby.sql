...
select isim, sum(urun_miktari)  from manav group by isim; -- asagidaki kodun aynisi sadece isimlendirme farkli
...
select urun_adi, count(isim)  -- aggregatelerin arasinda bosluk olmaz eger count (isim) olsaydi hata alirdik.
from manav 
...
-- SORU4: kisi ismine ve urun adına göre;
-- satılan ürünlerin toplamını gruplandıran ve isime göre ters sırasıda listeyen sorguyu yazınız.
